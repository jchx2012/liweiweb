        ...
        afterLoad:function(link,index){
            switch(index){
                ...
                case 3:
                    ...
                    /*第三屏 个人介绍点击区域*/
                    var oli =$("#sec3Nav li"),odiv=$(".sec3Box");
                    for(var i=0;i<oli.length;i++){
                        ...
                        oli[i].onclick=function(){
                            for(var j=0; j<odiv.length;j++){
                                ...
                                odiv[that.index].style.display="block";
                            }
                        }
                    }
